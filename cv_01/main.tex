...
\MyName{Milton Ferreira Lima Filho}
...
\begin{minipage}{0.55\textwidth}
	\begin{tabular}{|p{\textwidth}}
		\textbf{Nascimento:} 05/04/1983 \newline
		\textbf{Estado civil:} Casado \newline
		\textbf{Email:} \href{mailto:flmiltex@gmail.com}{flmiltex@gmail.com} \newline
		\textbf{Redes Sociais:} \newline
		\href{https://www.linkedin.com/in/flmilton}{LinkedIn }
		\href{https://www.facebook.com/flmilton}{ Facebook}
	\end{tabular}
\end{minipage}%
...
%%% ------------------------------------------------------------
\NewPart{Resumo}{}
Tenho mais de 10 anos de experiência com desenvolvimento de \textit{software}. Colaborei em diversos projetos, tanto em fábricas de \textit{software}, quanto alocado em clientes de vários seguimentos de negócios.
...
\EducationEntry{Universidade Federal de Minas Gerais}{2021 (in progress)}{Mestrado}{
	\begin{itemize}
		\item{Inteligência Computacional para Otimização}

	\end{itemize}
}


\EducationEntry{Universidade Federal de Minas Gerais}{2017 - 2018}{Pós-graduação (especialização)}{
	\begin{itemize}
...
\EducationEntry{Universidade Federal de Ouro Preto}{2008 - 2012}{Graduação}{
	\begin{itemize}
		\item{Bacharelado em Sitemas de Informação }

	\end{itemize}
}

\EducationEntry{SENAI/CETEL}{2003 - 2004}{Técnico}{
	\begin{itemize}
		\item{Técnico em Eletrônica }

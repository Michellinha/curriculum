...
{
    \Large{Milton Ferreira Lima Filho} \newline
    \small{
        \clink{
            \href{mailto:flmiltex@gmail.com}{flmiltex@gmail.com} \textbf{·} 
            {\fontdimen2\font=0.75ex +55 31 988336867} 
            \textbf{·} 
            \href{https://linkedin.com/in/flmilton}{LinkedIn}
        } \newline
...
{
    \hfill
    \includegraphics[width=2.8cm]{images/perfil.jpeg}
}
\end{tabularx}
\begin{center}
